...
var debug = require('debug')('app:verification/actions/fetchMoreVerifications');

let { inputDateFormat: DATE_FORMAT } = require('./../../../main/config');

export default function (context, params, done) {
  context.dispatch('FETCH_MORE_VERIFICATION_START');
  ...
  setTimeout(function () {
    context.dispatch('FETCH_MORE_VERIFICATION_SUCCESS', {
      items: pageData,
