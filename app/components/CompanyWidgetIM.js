...
var CompanyWidgetIM = React.createClass({
  getInitialState: function() {
    let state = {};
    for (let key in this.props.widgets.calls) {
      _.assign(state, {['widget-' + key]: this.props.widgets.im[key]});
    }
    return state;
  },
      ...
      <div className={classNames({'hide': this.props.isHidden})}>
        ...
        <div className="large-24 columns">
          ...
          <div className="large-15 columns">
            <input
              type="text" name="im-widget-1" placeholder="url"
        ...
        <div className="large-24 columns">
          ...
          <div className="large-15 columns">
            <input
              type="text" name="im-widget-2" placeholder="url"
        ...
        <div className="large-24 columns">
          ...
          <div className="large-15 columns">
            <input
              type="text" name="im-widget-3" placeholder="url"
        ...
        <div className="large-24 columns">
          ...
          <div className="large-15 columns">
            <input
              type="text" name="im-widget-4" placeholder="url"
        ...
        <div className="large-24 columns">
          ...
          <div className="large-15 columns">
            <input
              type="text" name="im-widget-5" placeholder="url"
        ...
        <div className="large-24 columns">
          ...
          <div className="large-15 columns">
            <input
              type="text" name="im-widget-6" placeholder="url"
...
export default CompanyWidgetIM;
